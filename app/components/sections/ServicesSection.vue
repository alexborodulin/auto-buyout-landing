...
const services = [
  ...
  {
    title: 'Trade-in',
    description: 'Примем ваш автомобиль в зачёт при покупке другого — быстро и выгодно.',
    cta: 'Обменять авто',
  ...
  {
    title: 'Оценка онлайн',
    description: 'Отправьте фото и VIN — предварительную цену назовём за 15 минут.',
    cta: 'Получить оценку',
